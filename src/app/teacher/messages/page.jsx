...
export default function TeacherMessagesPage() {
  ...
  useEffect(() => {
    ...
    async function boot() {
      ...
      if (sessionErr) {
        setStatus(sessionErr.message || "Failed to read session.");
        setLoading(false);
        return;
      }
      ...
      if (roleErr) {
        setStatus(roleErr.message || "Unable to verify role.");
        setLoading(false);
        return;
      }
  ...
  return (
    <div style={wrap}>
      <div style={card}>
        ...
        <div style={topBar}>
          <button type="button" onClick={() => setComposeOpen(true)} style={composeBtn}>
            COMPOSE
          </button>
        ...
        <div style={bodyGrid}>
          ...
          <div style={listArea}>
            ...
            <div style={footerBar}>
              <button type="button" onClick={moveSelectedToTrash} style={trashBtn}>
        ...
        <div onClick={() => setComposeOpen(false)} style={modalOverlay}>
          <div onClick={(e) => e.stopPropagation()} style={modalCard}>
            <div style={modalHeader}>
              <span>Compose</span>
              <button type="button" onClick={() => setComposeOpen(false)} style={modalClose}>
                ×
              </button>
            </div>
            ...
            <div style={{ padding: 12 }}>
              ...
              <div style={modalBtns}>
                <button type="button" onClick={sendMessage} style={sendBtn}>
                  Send
                </button>
                <button type="button" onClick={() => setComposeOpen(false)} style={cancelBtn}>
                  Cancel
                </button>
              </div>
            </div>
